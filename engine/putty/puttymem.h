...
#ifdef MALLOC_LOG
#define smalloc(z) (mlog(__FILE__ ,__LINE__,"smalloc"), safemalloc(z,1))
#define snmalloc(z,s) (mlog(__FILE__,__LINE__,"snmalloc"), safemalloc(z,s))
#define srealloc(y,z) (mlog(__FILE__,__LINE__,"srealloc"), saferealloc(y,z,1))
#define snrealloc(y,z,s) (mlog(__FILE__,__LINE__,"snrealloc"), saferealloc(y,z,s))
#define sfree(z) (mlog(__FILE__,__LINE__,"sfree"), safefree(z))
