...
EXPORT_C int conf_get_int(Conf *conf, int primary)
{
    struct key key;
    struct conf_entry *entry;
...
EXPORT_C int conf_get_int_int(Conf *conf, int primary, int secondary)
{
    struct key key;
    struct conf_entry *entry;
...
EXPORT_C char *conf_get_str(Conf *conf, int primary)
{
    struct key key;
    struct conf_entry *entry;
...
EXPORT_C Filename *conf_get_filename(Conf *conf, int primary)
{
    struct key key;
    struct conf_entry *entry;
...
EXPORT_C FontSpec *conf_get_fontspec(Conf *conf, int primary)
{
    struct key key;
    struct conf_entry *entry;
...
EXPORT_C void conf_set_int(Conf *conf, int primary, int value)
{
...
EXPORT_C void conf_set_int_int(Conf *conf, int primary, int secondary, int value)
{
    struct conf_entry *entry = snew(struct conf_entry);
...
EXPORT_C void conf_set_str(Conf *conf, int primary, const char *value)
{
    struct conf_entry *entry = snew(struct conf_entry);
...
EXPORT_C void conf_set_filename(Conf *conf, int primary, const Filename *value)
{
    struct conf_entry *entry = snew(struct conf_entry);
...
EXPORT_C void conf_set_fontspec(Conf *conf, int primary, const FontSpec *value)
{
    struct conf_entry *entry = snew(struct conf_entry);
