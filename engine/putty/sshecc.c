                              ...
                              const unsigned char *Gy)
{
    ...
    /* Curve co-efficients */
    curve->u.w.a = bignum_from_bytes(a, length);
    curve->u.w.b = bignum_from_bytes(b, length);
                              ...
                              const unsigned char *Gx)
{
    ...
    /* Curve co-efficients */
    curve->u.m.a = bignum_from_bytes(a, length);
    curve->u.m.b = bignum_from_bytes(b, length);

    /* Generator */
    curve->u.m.G.x = bignum_from_bytes(Gx, length);
    curve->u.m.G.y = NULL;
    curve->u.m.G.z = NULL;
    curve->u.m.G.curve = curve;
    curve->u.m.G.infinity = 0;
}
                              ...
                              const unsigned char *Bx, const unsigned char *By)
{
    ...
    /* Curve co-efficients */
    curve->u.e.l = bignum_from_bytes(l, length);
    curve->u.e.d = bignum_from_bytes(d, length);
...
static const unsigned char ec_p256_p[] = {
    0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff
};
static const unsigned char ec_p256_a[] = {
    0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfc
};
static const unsigned char ec_p256_b[] = {
    0x5a, 0xc6, 0x35, 0xd8, 0xaa, 0x3a, 0x93, 0xe7,
    0xb3, 0xeb, 0xbd, 0x55, 0x76, 0x98, 0x86, 0xbc,
    0x65, 0x1d, 0x06, 0xb0, 0xcc, 0x53, 0xb0, 0xf6,
    0x3b, 0xce, 0x3c, 0x3e, 0x27, 0xd2, 0x60, 0x4b
};
static const unsigned char ec_p256_n[] = {
    0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xbc, 0xe6, 0xfa, 0xad, 0xa7, 0x17, 0x9e, 0x84,
    0xf3, 0xb9, 0xca, 0xc2, 0xfc, 0x63, 0x25, 0x51
};
static const unsigned char ec_p256_Gx[] = {
    0x6b, 0x17, 0xd1, 0xf2, 0xe1, 0x2c, 0x42, 0x47,
    0xf8, 0xbc, 0xe6, 0xe5, 0x63, 0xa4, 0x40, 0xf2,
    0x77, 0x03, 0x7d, 0x81, 0x2d, 0xeb, 0x33, 0xa0,
    0xf4, 0xa1, 0x39, 0x45, 0xd8, 0x98, 0xc2, 0x96
};
static const unsigned char ec_p256_Gy[] = {
...
static struct ec_curve *ec_p256(void)
{
    if (!statics()->ec_p256_initialised)
    {
        ...
        statics()->ec_p256_initialised = 1;
    }

    return statics()->ec_p256_curve;
}


static const unsigned char ec_p384_p[] = {
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char ec_p384_a[] = {
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe,
...
static const unsigned char ec_p384_b[] = {
...
static const unsigned char ec_p384_n[] = {
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char ec_p384_Gx[] = {
...
static const unsigned char ec_p384_Gy[] = {
...
static struct ec_curve *ec_p384(void)
{
    if (!statics()->ec_p384_initialised)
    {
        ...
        /* Now initialised, no need to do it again */
        statics()->ec_p384_initialised = 1;
    }

    return statics()->ec_p384_curve;
}


static const unsigned char ec_p521_p[] = {
...
static const unsigned char ec_p521_a[] = {
    0x01, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char ec_p521_b[] = {
...
static const unsigned char ec_p521_n[] = {
    0x01, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static const unsigned char ec_p521_Gx[] = {
...
static const unsigned char ec_p521_Gy[] = {
...
static struct ec_curve *ec_p521(void)
{
    if (!statics()->ec_p521_initialised)
    {
        ...
        /* Now initialised, no need to do it again */
        statics()->ec_p521_initialised = 1;
    }

    return statics()->ec_p521_curve;
}

static const unsigned char ec_curve25519_p[] = {
    0x7f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xed
};
static const unsigned char ec_curve25519_a[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x07, 0x6d, 0x06
};
static const unsigned char ec_curve25519_b[] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01
};
static const unsigned char ec_curve25519_gx[32] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static struct ec_curve *ec_curve25519(void)
{
    if (!statics()->ec_curve25519_initialised)
    {
        ...
        statics()->ec_curve25519_curve->name = NULL;
        statics()->ec_curve25519_curve->textname = "Curve25519";

        /* Now initialised, no need to do it again */
        statics()->ec_curve25519_initialised = 1;
    }

    return statics()->ec_curve25519_curve;
}

static const unsigned char ec_ed25519_q[] = {
    0x7f, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xed
};
static const unsigned char ec_ed25519_l[32] = {
    0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x14, 0xde, 0xf9, 0xde, 0xa2, 0xf7, 0x9c, 0xd6,
    0x58, 0x12, 0x63, 0x1a, 0x5c, 0xf5, 0xd3, 0xed
};
static const unsigned char ec_ed25519_d[32] = {
...
static const unsigned char ec_ed25519_Bx[32] = {
...
static const unsigned char ec_ed25519_By[32] = {
...
static struct ec_curve *ec_ed25519(void)
{
    if (!statics()->ec_ed25519_initialised)
    {
        ...
        initialise_ecurve(statics()->ec_ed25519_curve, 256, ec_ed25519_q, ec_ed25519_l, ec_ed25519_d, ec_ed25519_Bx, ec_ed25519_By);
        statics()->ec_ed25519_curve->textname = "Ed25519";

        /* Now initialised, no need to do it again */
        statics()->ec_ed25519_initialised = 1;
    }

    return statics()->ec_ed25519_curve;
}
...
static int ec_aminus3(const struct ec_curve *curve)
{
    ...
    _p = bignum_add_long(curve->u.w.a, 3);
...
static int ec_point_verify(const struct ec_point *a)
{
    if (a->infinity) {
        ...
        tmp = modmul(a->curve->u.e.d, x2, a->curve->p);
        ...
        freebn(Three);
        ax = modmul(a->curve->u.w.a, a->x, a->curve->p);
        x3ax = bigadd(x3, ax);
        freebn(x3); x3 = NULL;
        freebn(ax); ax = NULL;
        x3axm = bigmod(x3ax, a->curve->p);
        freebn(x3ax); x3ax = NULL;
        x3axb = bigadd(x3axm, a->curve->u.w.b);
...
static struct ec_point *ecp_doublew(const struct ec_point *a, const int aminus3)
{
    ...
    if (aminus3) {
        ...
        if (a->z == NULL) {
            ...
            freebn(Z2);
            aZ4 = modmul(a->curve->u.w.a, Z4, a->curve->p);
            freebn(Z4);
        }
...
static struct ec_point *ecp_doublem(const struct ec_point *a)
{
    ...
    /* outz = 4xz * ((x - z)^2 + ((A + 2) / 4)*4xz) */
    {
        ...
        tmp2 = ecf_add(a->curve->u.m.a, tmp, a->curve);
        freebn(tmp);
                                 ...
                                 const struct ec_point *b)
{
     ...
     *        (1 + a->curve->u.e.d * a->x * b->x * a->y * b->y) */
    {
        Bignum tmp, tmp2, tmp3, tmp4;
        ...
        freebn(tmp);
        freebn(tmp2);
        dmul = modmul(a->curve->u.e.d, tmp4, a->curve->p);
        freebn(tmp4);
                                   ...
                                   const struct ec_point *point)
{
    ...
    aG = ecp_mul_(&point->curve->u.w.G, a, aminus3);
    if (!aG) return NULL;
...
static Bignum *ecp_edx(const struct ec_curve *curve, const Bignum y)
{
    ...
    /* xx = (y^2 - 1) / (d * y^2 + 1) */
    {
        ...
        tmp2 = modmul(curve->u.e.d, tmp, curve->p);
...
{
    if (curve->type == EC_WEIERSTRASS) {
        return ecp_mul(&curve->u.w.G, privateKey);
                         ...
                         const Bignum r, const Bignum s)
{
    ...
    /* Sanity checks */
    if (bignum_cmp(r, Zero) == 0 || bignum_cmp(r, publicKey->curve->u.w.n) >= 0
        || bignum_cmp(s, Zero) == 0 || bignum_cmp(s, publicKey->curve->u.w.n) >= 0)
    {
        return 0;
    }
    ...
    n_bits = bignum_bitcount(publicKey->curve->u.w.n);
    ...
    {
        Bignum tmp = bigmod(z, publicKey->curve->u.w.n);
        freebn(z);
        z = tmp;
    }
    ...
    /* Calculate signature */
    {
        ...
        w = modinv(s, publicKey->curve->u.w.n);
        if (!w) {
            freebn(z);
            return 0;
        }
        u1 = modmul(z, w, publicKey->curve->u.w.n);
        u2 = modmul(r, w, publicKey->curve->u.w.n);
        freebn(w);
        ...
        x = bigmod(tmp->x, publicKey->curve->u.w.n);
        ec_point_free(tmp);
                        ...
                        Bignum *r, Bignum *s)
{
    ...
    *s = NULL;
    ...
    /* z = left most bitlen(curve->n) of data */
    z = bignum_from_bytes(data, dataLen);
    n_bits = bignum_bitcount(curve->u.w.n);
    z_bits = bignum_bitcount(z);
    if (z_bits > n_bits)
    {
        Bignum tmp;
    ...
    k = dss_gen_k("ECDSA deterministic k generator", curve->u.w.n, privateKey,
                  digest, sizeof(digest));

    kG = ecp_mul(&curve->u.w.G, k);
    if (!kG) {
        freebn(z);
        freebn(k);
        return;
    ...
    /* r = kG.x mod n */
    *r = bigmod(kG->x, curve->u.w.n);
    ec_point_free(kG);

    /* s = (z + r * priv)/k mod n */
    {
        Bignum rPriv, zMod, first, firstMod, kInv;
        rPriv = modmul(*r, privateKey, curve->u.w.n);
        zMod = bigmod(z, curve->u.w.n);
        freebn(z);
        first = bigadd(rPriv, zMod);
        freebn(rPriv);
        freebn(zMod);
        firstMod = bigmod(first, curve->u.w.n);
        freebn(first);
        kInv = modinv(k, curve->u.w.n);
        freebn(k);
        if (!kInv) {
            freebn(firstMod);
            freebn(*r);
        ...
        *s = modmul(firstMod, kInv, curve->u.w.n);
        freebn(firstMod);
        freebn(kInv);
    }
}
                           ...
                           const char *data, int datalen)
{
    ...
    if (ec->publicKey.curve->type == EC_EDWARDS) {
        ...
        /* Verify sB == r + h*publicKey */
        {
            ...
            /* lhs = sB */
            lhs = ecp_mul(&ec->publicKey.curve->u.e.B, s);
            freebn(s);
            if (!lhs) {
                ec_point_free(r);
                freebn(h);
                                 ...
                                 int *siglen)
{
    ...
    if (ec->publicKey.curve->type == EC_EDWARDS) {
         ...
         * S = (r + H(encodepoint(R) + encodepoint(pk) + m) * a) % l */
        {
            ...
            rp = ecp_mul(&ec->publicKey.curve->u.e.B, r);
            if (!rp) {
                freebn(r);
                freebn(a);
                return NULL;
...

            {
                ...
                tmp2 = modmul(tmp, a, ec->publicKey.curve->u.e.l);
                freebn(a);
                freebn(tmp);
                tmp = bigadd(r, tmp2);
                freebn(r);
                freebn(tmp2);
                s = bigmod(tmp, ec->publicKey.curve->u.e.l);
                freebn(tmp);
            }
        }
...
void *ssh_ecdhkex_newkey(const struct ssh_kex *kex)
{
    ...
    if (curve->type == EC_MONTGOMERY) {
        ...
        publicKey = ecp_mul(&key->publicKey.curve->u.m.G, key->privateKey);
        if (!publicKey) {
        ...
        publicKey = ecp_mul(&key->publicKey.curve->u.w.G, key->privateKey);
        if (!publicKey) {
            freebn(key->privateKey);
            sfree(key);
            return NULL;
...
static const struct ssh_signkey * const algs_with_oid[] = {
    &ssh_ecdsa_nistp256,
    &ssh_ecdsa_nistp384,
    &ssh_ecdsa_nistp521,
};
